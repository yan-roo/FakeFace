...
def resize_img(path, width, height, mode):
    """
    ...
    for file in os.listdir(path):
        ...
        if image.size != (width, height):  # HACK - Check if image is from the CELEBA dataset
            ...
            image.save(os.path.join(path, f'{file}'))
...
if __name__ == "__main__":
    ...
    download_extract(args.dir)
    # resize_img(f'{args.dir}/img_align_celeba', args.width, args.height, mode='RGB')
